...
setwd('D:/Trambak/Dropbox/Research/Double Shrinkage/NEST Biometrika review_May2020/NEST/simulations')
#setwd('C:/Users/Padma/Dropbox/Trambak-Padma/Double Shrinkage - Trambak')



##-------------- Fixed n and sigma varying --------------

exp_5<-function(n,M,sigma2_u,reps){
...
out_m10<-exp_5(n,M[1],sigma2_u,reps)
out_m30<-exp_5(n,M[2],sigma2_u,reps)
out_m50<-exp_5(n,M[3],sigma2_u,reps)
...
save.image(paste(getwd(),'/fig4.RData',sep=''))
