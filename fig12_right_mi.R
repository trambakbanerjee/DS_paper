...
exp_2<-function(n,sigma2_u,reps){
...
plotdata1<- as.data.frame(c(colMeans(out_mi$risk.gl)/colMeans(out_mi$risk.ds_orc),
                            ...
                            colMeans(out_mi$risk.ds_mcv,na.rm = T)/colMeans(out_mi$risk.ds_orc)))
...
save.image(paste(getwd(),'fig12_right_mi.RData',sep=''))
